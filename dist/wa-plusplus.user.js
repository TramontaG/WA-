...
(function (preact) {
  ...
  const devSource = "http://127.0.0.1:5173/__vite-plugin-monkey.entry.js";
  const devAllowMetaTag = document.createElement("meta");
  devAllowMetaTag.setAttribute("http-equiv", "Content-Security-Policy");
  devAllowMetaTag.setAttribute("content", `default-src *`);
  document.head.append(devAllowMetaTag);
  preact.render(u(App, {}), (() => {
